...
class CoffeeShop {
    ...
    public static void main(String[] args) {
        ...
        menu.add(new MenuItem("Lemonde", "drink", 2.0));
        menu.add(new MenuItem("Croissant", "food", 3.0));
        menu.add(new MenuItem("Orange Juice", "drink", 2.5));
        menu.add(new MenuItem("Cinnmon Roll", "food", 2.5));
        menu.add(new MenuItem("Muffin", "food", 2.5));

        CoffeeShop shop = new CoffeeShop("My Coffee Shop", menu);
        ...
        List<String> listOrders = shop.listOrders();
